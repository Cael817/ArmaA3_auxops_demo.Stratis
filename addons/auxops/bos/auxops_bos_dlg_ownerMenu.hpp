...
// ******************************************************************************************
//	@file Version:
//	@file Name: auxops_bos_dlg_ownerMenu.hpp
//	@file Author: Cael817
//	@file Credits:
//	@file Info:

class auxops_base_owner_menu
{
	idd=-1;
	movingenable=false;
	class controls 
	{
		...
		{
			idc = 1605;
			text = "Setup Base Lights";
			x = 0.325;
			y = 0.54;
			w = 0.35;
			h = 0.05;
			Action = "call auxops_bos_fnc_lights_perimeter";
		};
		class kp_key_7: auxops_RscButton
		{
			...
			w = 0.35;
			h = 0.05;
			Action = "call auxops_vos_fnc_camonet"; //Cael817, uses the camonet for vehicles right now
		};
